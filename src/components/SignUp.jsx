...
const SignUp = () => {
  return (
    <section className="bg-slate-100">
      <div className="flex flex-col md:flex-row gap-12 px-5 md:px-12 justify-center py-12 h-screen 2xl:max-w-7xl mx-auto items-center">
        ...
        <div className="flex justify-center items-center md:w-1/2 w-full">
          <form className="bg-white p-4 md:p-6 rounded-2xl shadow-xl max-w-md w-full">
            ...
            <button
              type="submit"
              className="w-full bg-themeColor text-white py-3 rounded-lg hover:bg-[#0e345ade] transition-colors mb-1 md:mb-5"
            >
            ...
            <div>
              <div className="flex justify-center items-center gap-3 mx-auto">
                ...
                <p className="p line mb-3 text-gray-400 my-2">
                  Or Sign Up With
                </p>
                <hr className="w-1/4 md:w-1/3" />
              </div>
