    ...
    <header>
      <nav className="w-[full] h-[60px] flex justify-around ">
        <div className="content-center items-center">
          <a href="#">
            <span className="bg-themeColor px-4 py-2  text-white font-bold content-center text-center">MEFF</span>
            <span href="#" className="px-2 py-2 content-center hover:bg-themeColor hover:text-white border-2 text-center">LIBRARY</span></a>
        </div>
