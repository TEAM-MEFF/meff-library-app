...
const NavbarResponsive = () => {
  ...
  return (
    <header className="flex justify-between md:flex-col bg-slate-200 w-full fixed top-0 z-50">
      <div className="flex items-center md:w-[92%]  mx-auto justify-center md:justify-between py-2 bg-slate-200 ">
        <div className="content-center items-center">
          <Link href="#">
            ...
            <span
              href="#"
              className=" px-2 py-1.5 text-lg text-themeColor content-center hover:bg-themeColor hover:text-white border-themeColor border- border-2 text-center"
            >
              LIBRARY
            </span>
          </Link>
      ...
      <nav className="flex items-center gap-2 md:w-[92%]  mx-auto py-2 justify-center bg-slate-200">
        <div
          className={`sm:min-h-fit  md:min-h-fit md:w-auto md:z-auto z-[1] px-12 py-6 md:py-0 absolute md:static bg-slate-200 min-h-[40vh] right-0  flex items-center transition-all duration-500 ease-in-out ${
            open
              ? "top-14 opacity-100"
        ...
        >
          <div className="flex sm:gap-5 sm:flex-row md:items-center gap-2 md:flex-row flex-col transition-all duration-1000 ease-in-out">
            <Link
              to="/"
              className="sm:text-base md:text-lg px-2 py-1 hover:bg-themeColor hover:text-white rounded"
            >
              Home
            </Link>
            <Link
