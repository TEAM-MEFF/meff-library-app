...
const Footer = () => {
  return (
    <section className="bg-themeColor py-8 px-5 ">
      <div className="2xl:max-w-7xl mx-auto">
        <div className="md:flex w-full md:justify-around text-white">
          <div className="flex flex-col gap-3">
            <h6 className="font-semibold text-2xl mb-3">CONTACT US</h6>
            <div className="text-slate-400 flex flex-col gap-3">
              <p>
                <span>
                  <IonIcon name="globe" className="text-xl mr-[0.4rem]" />
                </span>{" "}
                www.mefflibrarygh.com
              </p>
              <p>
                <span>
                  <IonIcon name="mail" className="text-xl mr-[0.4rem]" />
                </span>{" "}
                info@mefflibrarygh.com
              </p>
              <p>
                <span>
                  <IonIcon name="call" className="text-xl mr-[0.4rem]" />
                </span>{" "}
                +233-456-7890
              </p>
              <p>
                <span>
                  <IonIcon
                    name="location-sharp"
                    className="text-xl mr-[0.4rem]"
                  />
                </span>{" "}
                Oxford Street, Achimoto, Accra - Ghana
              </p>
              <p>
                <span>
                  <IonIcon name="time" className="text-xl mr-[0.4rem]" />
                </span>{" "}
              ...
              <form className="flex flex-col gap-2" action="">
                ...
                <div className="flex mt-5 ">
                  <input
                    ...
                    className="w-[30px]"
                  />
                  <label className="mt-5 ml-3 mr-8" htmlFor="checkbox">
        ...
        <div className="flex flex-col md:flex-row md:justify-around">
          <div className="content-center items-center shadow-lg">
            <Link href="#">
          ...
          <div className="flex flex-col md:flex-row md:justify-around gap-24 ">
            <ul className="flex flex-col md:flex-row md:justify-around gap-x-10 text-slate-400">
        ...
        <div>
          <p className="text-white text-center font-mono mt-3">
            Made with ❤️ by <span className="names">M</span>ichael,{" "}
